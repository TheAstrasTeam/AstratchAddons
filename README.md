...
addons/<id>/
  ...
  README/<locale>.md          Optional localized README files
...
| `astratch.version` | no | Compatible Astratch version range (semver range) |
...
Icon, i18n, and README use **paths relative to the version directory**, not inline data. The client fetches them on demand.
